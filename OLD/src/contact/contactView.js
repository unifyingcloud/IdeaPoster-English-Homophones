...
define(["build/contact/contact"], function(ContactController) {
	...
	var ContactNavbar = React.createClass({
		render: function() {
			var header = this.props.Homophonestate.isNew ? "New contact" : "Contact";
			return (
				<div className="navbar-wrapper">
					...
					<div className="center Homophones-header">{header}</div>
	...
	return {
		init: function(query) {
			...
			React.renderComponent(<ContactNavbar Homophonestate = {ContactController.state}/>, document.getElementById('contact-navbar'));
